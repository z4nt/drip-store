...
export default function ColecoesEmDestaque() {
    return (
        <div>
            <header className="text-left ml-32 mb-4 mt-6">
            ...
            <div className="meio">
                <p className="mt-16 mb-6 text-[#474747] text-[24px] font-bold">Coleções em destaque</p>
            </div>

            <div className='mb-2'>
                <figure className="flex justify-center items-center gap-10">
                ...
                <figure className="flex justify-center items-center gap-20 mr-0 mt-0">
                    <div className="icones-direção text-center text-lg text-[#474747] font-bold">
                        Camiseta
                    </div>
                    <div className="icones-direção text-center text-lg text-[#474747] font-bold">
                        Calça
                    </div>
                    <div className="icones-direção t text-lg text-[#474747] font-bold">
                        Bonés
                    </div>
                    <div className="icones-direção text-center text-lg text-[#474747] font-bold">
                        Headphones
                    </div>
                    <div className="icones-direção text-center text-lg px-0 text-[#474747] font-bold">
                        <p className=''>Tênis</p>
                    </div>
                </figure>
            </div>
